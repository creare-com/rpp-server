...
def semver():
    """Return semantic version of current SoilMAP RPP Server installation

    Returns
    -------
    str
        Semantic version of the current SoilMAP RPP Server installation
    """
    return ".".join([str(v) for v in VERSION])


def version():
    """Retrieve SoilMAP RPP Server semantic version as string
    ...
    try:
        ...
        print("Could not determine SoilMAP RPP Server version from git repo.\n" + str(e))
